;*****************************************************************
; Programme : GPA770-Lab-1D
; Auteurs : Alexandre H.Lamarche ET Antoine Dozois
;
; Description :
;	Evaluer le profil de vitesse et l'afficher sur le terminal.
;*****************************************************************
...
Neutre:		EQU		3000		; Valeurs d'arret
